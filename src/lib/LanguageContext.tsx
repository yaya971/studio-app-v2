...
const translations = {
  fr: {
    ...
    // Profil (Mise à jour avec les nouveaux boutons)
    "prof.title": "Mon Profil", "prof.subtitle": "Gère tes infos.", "prof.logout": "Se déconnecter", "prof.info": "Mes Informations", "prof.name": "Nom", "prof.email": "Email", "prof.member": "Membre depuis le", "prof.no_info": "Non trouvé.", "prof.edit": "Modifier le profil", "prof.phone": "Téléphone", "prof.save": "Enregistrer", "prof.cancel": "Annuler", "prof.upload_err": "Erreur lors de l'envoi : ",
  ...
  en: {
    ...
    // Profil (Mise à jour avec les nouveaux boutons)
    "prof.title": "Profile", "prof.subtitle": "Manage info.", "prof.logout": "Log out", "prof.info": "My Info", "prof.name": "Name", "prof.email": "Email", "prof.member": "Member since", "prof.no_info": "Not found.", "prof.edit": "Edit profile", "prof.phone": "Phone", "prof.save": "Save", "prof.cancel": "Cancel", "prof.upload_err": "Upload error: ",
  ...
  pt: {
    ...
    // Profil (Mise à jour com os novos botões)
    "prof.title": "Perfil", "prof.subtitle": "Suas informações.", "prof.logout": "Sair", "prof.info": "Minhas Informações", "prof.name": "Nome", "prof.email": "Email", "prof.member": "Membro desde", "prof.no_info": "Não encontrado.", "prof.edit": "Editar perfil", "prof.phone": "Telefone", "prof.save": "Salvar", "prof.cancel": "Cancelar", "prof.upload_err": "Erro no upload: ",
