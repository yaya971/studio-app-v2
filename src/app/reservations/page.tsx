  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto h-[calc(100vh-80px)] md:h-screen flex flex-col">
      <div className="mb-6 shrink-0">
        <h1 className="text-3xl font-bold text-[#4ade80] drop-shadow-[0_0_8px_rgba(74,222,128,0.8)]">Réservation</h1>
        <p className="mt-2 text-gray-400 font-bold">Bloquez votre prochaine session studio, tournage ou mixage.</p>
      </div>
